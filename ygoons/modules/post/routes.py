...
def upload_post():
    ...
    song_path = secure_filename(os.path.join(user_id, post_data['songFile']))
    clip_path = secure_filename(os.path.join(user_id, post_data['clipFile']))
    with flask.g.pymysql_db.cursor() as cursor:
        ...
        '''
        cursor.execute(sql, (user_id, post_data['content'], post_data['tags'], post_data['songId'],
                             post_data['startTime'], post_data['endTime'], clip_path, song_path))
